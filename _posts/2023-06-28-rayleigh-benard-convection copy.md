...
Let $n$ be laplacian order and let $f: \mathbb{R}^k \to \mathbb{R}$ be a function such that $f \in C^n(\mathbb{R}^k)$. The common rule for higer order laplacians is given by
